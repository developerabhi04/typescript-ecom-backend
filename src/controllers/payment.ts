...
import { NewDiscountRequestBody, OrderItemType, ShippingInfoType } from "../types/types.js";
...
export const newCoupon = TryCatch(async (req: Request<{}, {}, NewDiscountRequestBody>, res, next) => {
